...
def start_hub(username):
    ...
    tk.Button(main_frame, text="Uhr", width=20, command=start_external_clock).pack(pady=10)
    tk.Button(main_frame, text="Stopuhr", width=20, command=start_external_Stopuhr).pack(pady=10)
    tk.Button(main_frame, text="Timer", width=20, command=start_external_Timer).pack(pady=10)
    tk.Button(main_frame, text="Planer", width=20, command=start_external_planer).pack(pady=10)
    tk.Button(main_frame, text="Dateimanager", width=20, command=start_external_Dateimanager).pack(pady=10)
    tk.Button(main_frame, text="Taschenrechner", width=20, command=start_external_taschenrechner).pack(pady=10)
    tk.Button(
        main_frame,
        text="Neuigkeiten",
        width=20,
        font=("Arial", 10, "bold"),
        bg="blue",          # Standard-Hintergrund (Blau)
        fg="white",         # Standard-Text (Weiß)
        activebackground="blue",  # Hintergrund beim Klicken (dunkleres Blau)
        activeforeground="white",  # Textfarbe beim Klicken
