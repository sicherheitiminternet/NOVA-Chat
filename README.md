...
Bitte lesen Sie die **[AGB](https://sicherheitiminternet.github.io/Nova-Chat-Webseite/agb.html)**, die **[Datenschutzerklärung](https://sicherheitiminternet.github.io/Nova-Chat-Webseite/datenschutz.html)** und die **[Chat-Regeln](https://sicherheitiminternet.github.io/Nova-Chat-Webseite/chat_rules.html)** direkt auf dieser Webseite.

## 2. Zulässige Nutzung

- **Herunterladen und privat nutzen:** Erlaubt.  
...
3. **Starten Sie den Chat**: Öffnen Sie die Datei `Main.pyw`.
...
* Wenn eine neue Version von **NOVA-Chat** veröffentlicht wird, **müssen Sie das Repository erneut herunterladen**, um aktuell zu bleiben.
* Alte Versionen dürfen **nicht verbreitet oder bearbeitet** werden.
